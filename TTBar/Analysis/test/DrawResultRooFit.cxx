{
 ...
 RooRealVar t_M_Reco("t_M_Reco","M_{jj}",0,200,"GeV/c^{2}") ;
 ...
 t_M_Reco.setRange("reduce",50,120);
...
//  gauss.plotOn(frame_t_M_Reco, RooFit::Name("gauss"),RooFit::LineColor(kRed));
 ...
 RooRealVar Mean_SimpleGauss_Fit("Mean_SimpleGauss_Fit","Mean Mean_SimpleGauss_Fit",1.0,0.9,1.1);
 RooRealVar Sigma_SimpleGauss_Fit("Sigma_SimpleGauss_Fit","Sigma Sigma_SimpleGauss_Fit",1.0,0.1,30.0);
