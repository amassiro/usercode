...
int main(int argc, char** argv){
 ...
 std::string inputFileMC = gConfigParser -> readStringOption("InputMC::inputFile");
 ...
 MinScan  = gConfigParser -> readDoubleOption("Options::MinScan");
 MaxScan  = gConfigParser -> readDoubleOption("Options::MaxScan");
 iNoSteps = gConfigParser -> readIntOption("Options::iNoSteps");
 ...
 MinScanRange  = gConfigParser -> readDoubleOption("Options::MinScanRange");
 MaxScanRange  = gConfigParser -> readDoubleOption("Options::MaxScanRange");
 ...
 std::string temp_cut = gConfigParser -> readStringOption("Options::cut");
 std::cout << ">>>>> Options::cut " << temp_cut.c_str() << std::endl;
 CorrectString(temp_cut);
...
// std::cout << ">>>>> input::entryMOD  " << entryMOD  << std::endl;  
 ...
 maxIter = gConfigParser -> readIntOption("Options::numToyMC");
