...
//  double MAX = 2000;
 ...
 for (int iIter = 0; iIter < nIter; iIter++){
  ...
  ///========= MASS =========
  ccMass.cd();
  TString drawMass = Form("Mass_RECO_After >> h1Mass");
  tree->Draw(drawMass,cutH2,"");
  TString nameCanvasMass = Form("test/plot/EvolutionMass_%d.gif",iIter);
  ccMass->SaveAs(nameCanvasMass);
  ccMass->SaveAs("test/plot/EvolutionMass.gif+");
