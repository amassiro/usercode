{
 ...
 for (int iSample = 0; iSample < numberOfSamples; iSample++){
  std::ofstream myfile;
  char nameFile[1000];
  sprintf(nameFile,"test/Spring11/dir_cfg_skimmed/NtupleProducerPATtoNT_%s.sh",nameSample[iSample]);
  ...
  myfile << "./bin/NtupleProducerFromPATtoNT.exe test/Spring11/dir_cfg_skimmed/NtupleProducerPATtoNT_" << nameSample[iSample] << ".cfg" << std::endl;
  myfile << std::endl;
  myfile.close(); 
