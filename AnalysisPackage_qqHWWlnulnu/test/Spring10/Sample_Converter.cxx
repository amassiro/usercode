{
 ...
 std::ifstream inFile("/home/andrea/Cern/Code/VBF/qqHWW/listOfSamples_Spring10.txt");
 std::string buffer;
...
//   std::cout << "buffer = " << buffer << std::endl;
  if (!(buffer.empty())){
   if (buffer.at(0) != '#'){ ///---> save from empty line at the end! --- and skip empty line!
    ...
    std::string buffer_temp(temp);
    if (buffer_temp != ""){
//      buffer_temp = line.str();
