{
 ...
 std::ifstream inFile("samples_temp.txt");
 std::string buffer;
 ...
 for (int iSample = 0; iSample < numberOfSamples; iSample++){
  std::ofstream myfile;
  char nameFile[1000];
  sprintf(nameFile,"FinalSelection_%s.cfg",nameSample[iSample]);
  ...
  myfile << "OutFileNameEfficiencies = /home/andrea/Cern/Code/VBF/qqHWW/AnalysisPackage_qqHWWlnulnu/output/out_FinalSelection_" << nameSample[iSample] << ".root" << std::endl;
  myfile << std::endl;
