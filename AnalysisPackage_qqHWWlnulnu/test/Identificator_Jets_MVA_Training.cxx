...
void Identificator_Jets_MVA_Training( TString myMethodList = "" ) {
 ...
 TString fname = "output/Identificator_Jets.root";
 
 // Create a new root output file.
 TString outfileName( "output/Identificator_Jets_trained.root" );
 ...
 TString mycuts_s = Form("Match4 == 2");
 TString mycuts_b = Form("Match4 != 0");
...
//  factory->PrepareTrainingAndTestTree( mycuts, mycutb,"SplitMode=Random:NormMode=NumEvents:!V:nTrain_Background=1000:nTrain_Signal=1000" );
