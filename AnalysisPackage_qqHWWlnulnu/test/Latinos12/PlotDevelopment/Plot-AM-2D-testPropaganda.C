...
//  std::vector<int> binsToSelectGR; 
//  binsToSelectGR.push_back (0);
//  for (int iX=0; iX<NX; iX++){
//   for (int iY=0; iY<NY; iY++){
//    binsToSelectGR.push_back (iX*NMAXY+iY+1);
// //    binsToSelectGR.push_back (iX*NMAXY+iY+1+1);
//    std::cout << " iX*NY+iY+1 = " << iX*NY+iY+1 << std::endl;
//   }
//  }
//  binsToSelectGR.push_back (NMAXY*NMAXX);
...
//  hs->set_ErrorBand( *(FilterBins(binsToSelectGR, (TGraphAsymmErrors*) f->Get(name))) );  
