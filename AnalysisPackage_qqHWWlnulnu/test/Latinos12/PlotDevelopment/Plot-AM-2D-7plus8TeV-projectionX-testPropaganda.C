...
void Plot_AM_2D_7plus8TeV_projectionX_testPropaganda() {
...
//   TFile* f0 = new TFile("postFitDF01J-78TeV/mH125_19.47fb_of_1j.root");
 ...
 //   TFile* f0 = new TFile("postFitDF01J-78TeV/mH125_4.94fb_of_0j.root");
 //  TFile* f0 = new TFile("postFitDF01J-78TeV/mH125_4.94fb_of_1j.root");
//  TFile* f0 = new TFile("postFitDF01J-78TeV/mH125_19.47fb_of_0j.root");
 //  TFile* f1 = new TFile("postFitDF01J-78TeV/mH125_19.47fb_of_1j.root");
...
//  hs->setLumi(12.103);
 ...
 hs->setLabel("m_{T}^{ll-E_{T}^{miss}} [GeV]");
