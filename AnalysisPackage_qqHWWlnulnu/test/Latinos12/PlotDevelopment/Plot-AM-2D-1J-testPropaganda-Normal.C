...
void Plot_AM_2D_1J_testPropaganda-Normal() {
...
//  TFile* f = new TFile("postFitMll/mH125.root");
 TFile* f = new TFile("postFitDF1J/of1j_mH125.root");
...
//  hs->DrawPropagandaPlot(c2,1,10,"m_{ll} [GeV]",0,200,"m_{T}^{ll-E_{T}^{miss}} [GeV]",80,280);
 hs->DrawPropagandaPlot(c2,1,8,"m_{T}^{ll-E_{T}^{miss}} [GeV]",80,280,"m_{ll} [GeV]",0,200,5,5);
