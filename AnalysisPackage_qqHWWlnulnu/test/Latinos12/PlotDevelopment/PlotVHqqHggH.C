...
//                         rref->SetPoint      (i,summed->GetBinCenter(i+1) - summed->GetBinWidth(i+1)/2., summed->GetBinContent(i+1)/scale);
                        ...
                        if (!_doBandError) {
                         rref->SetPointError (i,summed->GetBinWidth(i+1)/2., summed->GetBinWidth(i+1)/2., summed->GetBinError(i+1)/scale, summed->GetBinError(i+1)/scale);                      
                        }
                        else {
...
//                std::cout << " ==== " << std::endl;
              ...
              if (data) {
               ...
               errYloDataMinusBkg = sqrt(errYloDataMinusBkg*errYloDataMinusBkg + data->GetBinContent(i+1)); //---- poissonian
               errYupDataMinusBkg = sqrt(errYupDataMinusBkg*errYupDataMinusBkg + data->GetBinContent(i+1)); //---- poissonian
