...
void AMPlotMacroCreator_HCP() {
 
 TString fileVar = Form("var06Oct.txt");
 
//  TString date    = Form("06Oct_HCP");
//  TString file    = Form("out_test_Latinos_06Oct2012_2200_Run2012ABC_8TeV_HCP.root");
 
 
//  TString date    = Form("09Oct_HCP");
//  TString file    = Form("out_test_Latinos_09Oct2012_2200_Run2012ABC_8TeV_HCP.root");
 
 
 TString date    = Form("09Oct_noPUW_HCP");
 TString file    = Form("out_test_Latinos_09Oct2012_2200_Run2012ABC_8TeV_HCP_unweightPUW.root");
 
 
 
 
 TString hmass   = Form("125");
 TString lumi    = Form("12.103");
...
//  for (int iCut = 0; iCut < 13; iCut++) {
  ...
  for (int iVar=0; iVar<vVar_simple.size(); iVar++) {
   ...
   myfile << " gInterpreter->ExecuteMacro(\"../Plot/LatinoStyle2.C\");" << std::endl;
   myfile << std::endl;  
   ...
   myfile << " vectNameSig.push_back (\"ggH m_{H}="<< hmass.Data() <<"\");" << std::endl;
   ...
   myfile << " vectTHSig.push_back ( (TH1F*) f->Get(name) );" << std::endl;
   myfile << " vectNameSig.push_back (\"qqH m_{H}="<< hmass.Data() <<"\");" << std::endl;
   myfile << " vectColourSig.push_back(634);" << std::endl;
   myfile << " vectScaleSig.push_back(1.0000);" << std::endl;
   myfile << std::endl;
   myfile << " name = Form(\"%sVH-"<< hmass.Data() <<"%s\",cutNameBefore.Data(),cutNameAfter.Data());" << std::endl;
   myfile << " vectTHSig.push_back ( (TH1F*) f->Get(name) );" << std::endl;
   myfile << " vectNameSig.push_back (\"VH m_{H}="<< hmass.Data() <<"\");" << std::endl;
   myfile << " vectColourSig.push_back(635);" << std::endl;
   myfile << " vectScaleSig.push_back(1.0000);" << std::endl;
   myfile << std::endl;
   ...
   //   myfile << " vectSystBkg.push_back(0.20);" << std::endl;
   myfile << " vectSystBkg.push_back(0.00);" << std::endl;
//    myfile << " vectScaleBkg.push_back(1.26);" << std::endl;
   myfile << " vectScaleBkg.push_back(1.0000);" << std::endl;
