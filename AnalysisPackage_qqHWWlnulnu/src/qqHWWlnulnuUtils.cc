...
//  if ((fabs(reader.Get4V("electrons")->at(iEle).Eta()) < 1.5) && reader.GetFloat("electrons_dcot")->at(iEle) > BarrelSelections.at(6)) skipEle = true;    
 if ((fabs(reader.Get4V("electrons")->at(iEle).Eta()) < 1.5) && (reader.GetFloat("electrons_dist")->at(iEle) < BarrelSelections.at(5) && reader.GetFloat("electrons_dcot")->at(iEle) > BarrelSelections.at(6)) ) skipEle = true;     
