...
//  TFile *_file1 = TFile::Open("output/out_TT_General_Calibrator_New.root");
 ...
 RooRealVar t_M_Reco("t_M_Reco","M_{jj}",40,140,"GeV/c^{2}") ;
 ...
 t_M_Reco.setRange("before",50,120);
...
//  RooBreitWigner BW("BW","BW PDF",t_M_Reco,Mean_Fit,Sigma_Fit);
 ...
 RooRealVar nsig("nsig","signal fraction",9999,0.,10000.) ;
 RooRealVar nbkg("nbkg","background fraction",1,0.,10000.) ;
