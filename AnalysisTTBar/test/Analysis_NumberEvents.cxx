{
 ...
 for (int i=0; i<17; i++){
  ...
  outfile_sh << "source /afs/cern.ch/sw/lcg/app/releases/ROOT/5.26.00/slc4_amd64_gcc34/root/bin/thisroot.sh" << std::endl;  
  outfile_sh << "CLHEPSYS=/afs/cern.ch/sw/lcg/external/clhep/2.0.4.5/slc4_amd64_gcc34/" << std::endl;
