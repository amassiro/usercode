...
//    histos[counterHistoPerFile * (iSample) + iHisto].Scale(XSection * preselection_efficiency * numEntriesBefore / histos[counterHistoPerFile * (iSample) + iHisto].GetEntries());
   histos[counterHistoPerFile * (iSample) + iHisto].Scale(1. / histos[counterHistoPerFile * (iSample) + iHisto].GetEntries());
   ...
   if (iSample == 0){
    ...
    histos[counterHistoPerFile * (iSample) + iHisto].SetFillStyle(0);
   }
   else if (iSample == 1){
