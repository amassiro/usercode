...
c++ -o TT_MC_4 `root-config --cflags --glibs` -lGenVector TT_MC_4.cpp dict.cpp treeReader.cc
*/
...
int main (int argc, char ** argv)
{
 ...
 TH1F pt_ele_nu("pt_ele_nu","pt_ele_nu",1000,0,1000);
 TH1F pt_mu_nu("pt_mu_nu","pt_mu_nu",1000,0,1000);
 TH1F pt_had("pt_had","pt_had",1000,0,1000);
 TH1F pt_d_had("pt_d_had","pt_d_had",1000,0,1000);
 TH1F pt_u_had("pt_u_had","pt_u_had",1000,0,1000);
 TH1F pt_s_had("pt_s_had","pt_s_had",1000,0,1000);
 TH1F pt_c_had("pt_c_had","pt_c_had",1000,0,1000);
 ...
 for (int iEvent = 0 ; iEvent < nentries ; ++iEvent)
 {
  ...
  if (fabs(mcF1_fromV1_pdgId->at(0)) == 12 || fabs(mcF1_fromV1_pdgId->at(0)) == 14){
   pt_lept.Fill(mcF1_fromV1->at(0).Pt());
   if (fabs(mcF1_fromV1_pdgId->at(0)) == 12) pt_ele_nu.Fill(mcF1_fromV1->at(0).Pt());
   if (fabs(mcF1_fromV1_pdgId->at(0)) == 14) pt_mu_nu.Fill(mcF1_fromV1->at(0).Pt());
   p_lept.Fill(mcF1_fromV1->at(0).P());
   p_nu.Fill(mcF1_fromV1->at(0).P());
  }
  if (fabs(mcF1_fromV2_pdgId->at(0)) == 12 || fabs(mcF1_fromV2_pdgId->at(0)) == 14){
   pt_lept.Fill(mcF1_fromV2->at(0).Pt());
   if (fabs(mcF1_fromV2_pdgId->at(0)) == 12) pt_ele_nu.Fill(mcF1_fromV2->at(0).Pt());
   if (fabs(mcF1_fromV2_pdgId->at(0)) == 14) pt_mu_nu.Fill(mcF1_fromV2->at(0).Pt());
   p_lept.Fill(mcF1_fromV2->at(0).P());
   p_nu.Fill(mcF1_fromV2->at(0).P());
  }
  if (fabs(mcF2_fromV1_pdgId->at(0)) == 12 || fabs(mcF2_fromV1_pdgId->at(0)) == 14){
   pt_lept.Fill(mcF2_fromV1->at(0).Pt());
   if (fabs(mcF2_fromV1_pdgId->at(0)) == 12) pt_ele_nu.Fill(mcF2_fromV1->at(0).Pt());
   if (fabs(mcF2_fromV1_pdgId->at(0)) == 14) pt_mu_nu.Fill(mcF2_fromV1->at(0).Pt());
   p_lept.Fill(mcF2_fromV1->at(0).P());
   p_nu.Fill(mcF2_fromV1->at(0).P());
  }
  if (fabs(mcF2_fromV2_pdgId->at(0)) == 12 || fabs(mcF2_fromV2_pdgId->at(0)) == 14){
   pt_lept.Fill(mcF2_fromV2->at(0).Pt());
   if (fabs(mcF2_fromV2_pdgId->at(0)) == 12) pt_ele_nu.Fill(mcF2_fromV2->at(0).Pt());
   if (fabs(mcF2_fromV2_pdgId->at(0)) == 14) pt_mu_nu.Fill(mcF2_fromV2->at(0).Pt());
   p_lept.Fill(mcF2_fromV2->at(0).P());
  ...
  if (fabs(mcF1_fromV1_pdgId->at(0)) <= 4){
   if (fabs(mcF1_fromV1_pdgId->at(0)) == 1) pt_d_had.Fill(mcF1_fromV1->at(0).Pt());
   if (fabs(mcF1_fromV1_pdgId->at(0)) == 2) pt_u_had.Fill(mcF1_fromV1->at(0).Pt());
   if (fabs(mcF1_fromV1_pdgId->at(0)) == 3) pt_s_had.Fill(mcF1_fromV1->at(0).Pt());
   if (fabs(mcF1_fromV1_pdgId->at(0)) == 4) pt_c_had.Fill(mcF1_fromV1->at(0).Pt());   
   pt_had.Fill(mcF1_fromV1->at(0).Pt());
   p_had.Fill(mcF1_fromV1->at(0).P());
  }
  if (fabs(mcF1_fromV2_pdgId->at(0)) <= 4){
   if (fabs(mcF1_fromV2_pdgId->at(0)) == 1) pt_d_had.Fill(mcF1_fromV2->at(0).Pt());
   if (fabs(mcF1_fromV2_pdgId->at(0)) == 2) pt_u_had.Fill(mcF1_fromV2->at(0).Pt());
   if (fabs(mcF1_fromV2_pdgId->at(0)) == 3) pt_s_had.Fill(mcF1_fromV2->at(0).Pt());
   if (fabs(mcF1_fromV2_pdgId->at(0)) == 4) pt_c_had.Fill(mcF1_fromV2->at(0).Pt());   
   pt_had.Fill(mcF1_fromV2->at(0).Pt());
   p_had.Fill(mcF1_fromV2->at(0).P());
  }
  if (fabs(mcF2_fromV1_pdgId->at(0)) <= 4){
   if (fabs(mcF2_fromV1_pdgId->at(0)) == 1) pt_d_had.Fill(mcF2_fromV1->at(0).Pt());
   if (fabs(mcF2_fromV1_pdgId->at(0)) == 2) pt_u_had.Fill(mcF2_fromV1->at(0).Pt());
   if (fabs(mcF2_fromV1_pdgId->at(0)) == 3) pt_s_had.Fill(mcF2_fromV1->at(0).Pt());
   if (fabs(mcF2_fromV1_pdgId->at(0)) == 4) pt_c_had.Fill(mcF2_fromV1->at(0).Pt());   
   pt_had.Fill(mcF2_fromV1->at(0).Pt());
   p_had.Fill(mcF2_fromV1->at(0).P());
  }
  if (fabs(mcF2_fromV2_pdgId->at(0)) <= 4){
   if (fabs(mcF2_fromV2_pdgId->at(0)) == 1) pt_d_had.Fill(mcF2_fromV2->at(0).Pt());
   if (fabs(mcF2_fromV2_pdgId->at(0)) == 2) pt_u_had.Fill(mcF2_fromV2->at(0).Pt());
   if (fabs(mcF2_fromV2_pdgId->at(0)) == 3) pt_s_had.Fill(mcF2_fromV2->at(0).Pt());
   if (fabs(mcF2_fromV2_pdgId->at(0)) == 4) pt_c_had.Fill(mcF2_fromV2->at(0).Pt());   
