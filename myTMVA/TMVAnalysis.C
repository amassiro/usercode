//---- modificato per analisi VBF


// @(#)root/tmva $Id: TMVAnalysis.C,v 1.245.2.7 2008/12/02 08:51:42 andreas.hoecker Exp $
/**********************************************************************************
...
void TMVAnalysis( TString myMethodList = "" ) 
{
   ...
   factory->AddVariable( "pair_DEta",        'F' );
   factory->AddVariable( "pair_Mjj",         'F' );
   factory->AddVariable( "pair_pt1",         'F' );
   factory->AddVariable( "pair_pt2",         'F' );
   factory->AddVariable( "pair_numJet",      'I' );
   factory->AddVariable( "pair_SumPtOthers", 'F' );
   factory->AddVariable( "pair_MjjOthers",   'F' );
   ...
   if (ReadDataFromAsciiIFormat) {
      ...
      TFile *input(0);
      TString fname = "smallfile_JetCorrection_H160_WW_2l.root";
//       TString fname = "smallfile_NOCORRECTION_H160_WW_2l.root";
